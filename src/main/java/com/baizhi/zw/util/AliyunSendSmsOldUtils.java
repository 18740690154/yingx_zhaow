...
public class AliyunSendSmsOldUtils {
    ...
    private static SendSmsResponse sendPhoneCode(String phoneNumbers, String signName, String templateCode, String templateParam) throws ClientException {
        ...
        //替换成你的AK
        final String accessKeyId = "LTAI4FtmnnJMcXyeJroyNe8y";//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "unjo5wFUFBR2B94cG748VPVffuCf3d";//你的accessKeySecret，参考本文档步骤2
    ...
    public static String sendCode(String phones,String code){
        ...
        String signName="风行";  //签名
        String templateCode="SMS_186953611";  //模板
